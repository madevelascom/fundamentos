...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/frontend/css/bootstrap-tagsinput.css'); ?>">
        ...
        <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/frontend/css/errorescss.css'); ?>" >
        ...
        <script type="text/javascript" src="<?php echo base_url('public/frontend/js/ckeditor.js'); ?>"></script>
