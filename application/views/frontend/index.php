						...
						<div class = 'container'>
							<div class = 'row pt-15'>
								...
								<div class = 'col-md-4 pt-xs-15'>
									...
									<div class="description">
										Cada vez más sistemas emplean computadoras, y la programación es el lenguaje que te permite comunicarte con la tecnología.
									</div>
								</div>
								<div class = 'col-md-4 pt-xs-15'>
									...
									<div class="description">
										Programar es otra forma de expresión. Podrás crear tus propias aplicaciones desde cero. 
									</div>
								</div>
							</div>
						</div>
