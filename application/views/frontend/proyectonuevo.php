			...
			<div class = 'col-md-offset-1 col-md-10'>
				<form>
					...
					<div class="form-group">
						...
						<input class="form-control validarTags" type="tags" placeholder="Añade algunos tags..." data-role="tagsinput" id="project-tags"/>
					</div>
					<div class="form-group">
					...
					<div class = 'align-center pt-20'>
						<button type="submit"  id="botonvalidacion" class="btn btn-default common-btn">Enviar proyecto</button>
